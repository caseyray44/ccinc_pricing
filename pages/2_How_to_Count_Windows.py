...
if st.session_state.page == "how_to_count_windows":
...
elif st.session_state.page == "top_grids_2_by_2":
    # This section is just a placeholder; the actual content is in 3_Top_Grids_2_by_2.py
    st.experimental_rerun()  # This will be handled by Streamlit's sidebar navigation
