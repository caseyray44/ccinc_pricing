...
st.markdown(
    ...
    /* Reduce top padding/margin to move columns closer to the title */
    .stColumns {
    ...
    /* Ensure the main content block has no extra top padding */
    .block-container {
        padding-top: 0px !important; /* Remove top padding from the main content block */
    }
    </style>
    """,
